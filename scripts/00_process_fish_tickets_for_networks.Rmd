...
tmpfile <- '2024_12_09_pacfin_fishtickets.csv' # latest pull from PacFIN 12-09-2024
...
write_rds(tmpfile2, paste0(out_conf_dir,'fish tickets 2010-2024 120924.rds'))
...
myfile2 <- 'fish tickets 2010-2024 120924.rds' # latest pull from PacFIN 12-09-2024
...
Remove fish tickets with an unknown (`UNKNOWN`) OR MISSING (`""` / `MISSING`) vessel identifier. As of December 2024, this results in dropping about 1.5M records.
```{r filter}
