...
db <- landings_iopac_mgrp %>%
  mutate(AFI_REV_m = AFI_REV/1000000) %>% # convert landings to millions
  filter(CRAB_YEAR >1981 & CRAB_YEAR < 2021) %>%  # restrict landings years
...
db_ma <- db %>% filter(MANAGEMENT_GROUP_CODE == 'TOTAL') %>%
