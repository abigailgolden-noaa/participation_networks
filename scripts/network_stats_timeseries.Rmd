...
## facetscales package author archived the package and recommends using cowplot or patchwork instead
...
```{r}
filenames <- c("VesselLevelNodeStats_2011_2024_21pcgroups_totalrev5000_indivrev500_connectivity_rmCrab_10pContribution.csv")
networkstats_filename <- "VesselLevelNetworkStats_2011_2024_21pcgroups_totalrev5000_indivrev500_connectivity_rmCrab_10pContribution.csv"
...
```{r}
myfisheries <- c('Salmon', 'Crab', 'Coastal pelagics')
```
<br>
...
... at WA and OR ports from 2011-2020. Importance (eigenvalue centrality) was derived from vessel-level networks summarized at the port level. Nodes (fisheries) are included in each network with a minimum total fisheries revenue cutoff for vessels of `$5,000` and a minimum revenue cutoff for individual fisheries of `$500`.
