...
mat <- revenue_matrix(tickets = fishtix, matrix_scale = "port", pcid_choose = "Astoria", year_choose = 2019,
                      filter_for_conf = TRUE, min_vessels = vessel_cutoff, min_contribution = contr_cutoff, 
