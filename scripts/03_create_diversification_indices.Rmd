...
mat <- revenue_matrix(tickets = fishtix, matrix_scale = "coastwide", matrix_type = "species", pcid_choose = NA, year_choose = 2019,
                      min_rev = total_rev_cutoff, min_rev_indiv = indiv_rev_cutoff)

tickets <- fishtix
matrix_scale <- "coastwide"
year_choose <- 2019
matrix_type <- "species"
